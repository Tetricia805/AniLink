    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Add clear photos of {animal.name} for analysis. You can skip this step, but photos may improve results.
          </CardDescription>
        </CardHeader>
      </Card>
        ...
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50/50 dark:border-amber-900/50 dark:bg-amber-950/20 p-3 text-sm">
            ...
            <p className="text-icon-amber opacity-90">
              You can skip photos and continue. Adding at least one photo may improve the AI assessment.
            </p>
          </div>
        </CardContent>
      </Card>
