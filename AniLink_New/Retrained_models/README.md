...
- `REACT_NATIVE_INTEGRATION.md` - Complete React Native integration guide with code examples
...
4. If Class 0 probability > 0.55 (and > Class 1 probability), proceed to Step 2
...
2. **Use confidence threshold of 0.55** for cattle detection (0.75 was too strict and rejected valid cattle)
