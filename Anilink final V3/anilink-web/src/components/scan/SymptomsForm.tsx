...
export function SymptomsForm({
  ...
  const description = animalName
    ? `Add common symptoms for ${animalName}, severity, duration, and any extra notes. At least one symptom or notes is required.`
    : "Add common symptoms, severity, duration, and any extra notes. At least one symptom or notes is required.";
