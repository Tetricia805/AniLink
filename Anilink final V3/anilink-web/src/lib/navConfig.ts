...
import { Home, Scan, Stethoscope, ShoppingCart, FileText, HeartPulse, Calendar, FolderOpen, Users, LayoutDashboard, Package, BarChart3, Settings, ShoppingBag, Wallet, User } from 'lucide-react'
...
/** Owner/Farmer: Home, Scan, Vets, Shop, Records, Symptom Checker. Notifications via bell icon only. */
export const OWNER_NAV_ITEMS: NavItem[] = [
  ...
  { id: 'symptom-checker', label: 'Symptom Checker', icon: HeartPulse, path: '/scan/symptoms' },
]
