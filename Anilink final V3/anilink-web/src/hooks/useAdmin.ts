...
export function useApproveVet() {
  ...
  return useMutation({
    ...
    onError: (err: unknown) => {
      const msg = getApiErrorMessage(err, 'Failed to approve vet')
      push({ title: 'Error', description: msg, variant: 'destructive' })
    },
  })
}
...
export function useRejectVet() {
  ...
  return useMutation({
    ...
    onError: (err: unknown) => {
      const msg = getApiErrorMessage(err, 'Failed to reject vet')
      push({ title: 'Error', description: msg, variant: 'destructive' })
    },
  })
}
...
export function useUpdateAdminProduct() {
  ...
  return useMutation({
    ...
    onError: (err: unknown) => {
      const msg = getApiErrorMessage(err, 'Failed to update product')
      push({ title: 'Error', description: msg, variant: 'destructive' })
    },
  })
}
...
export function useUpdateAdminSettings() {
  ...
  return useMutation({
    ...
    onError: (err: unknown) => {
      const msg = getApiErrorMessage(err, 'Failed to save settings')
      push({ title: 'Error', description: msg, variant: 'destructive' })
    },
  })
}
