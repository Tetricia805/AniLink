...
const quickActions = [
  {
    id: 1,
    title: "Quick Scan",
    description: "Upload a photo for AI health assessment",
    icon: Scan,
    path: "/scan",
  ...
  },
  {
    ...
    description: "Describe symptoms for preliminary recommendations",
    icon: HeartPulse,
    path: "/scan/symptoms",
  ...
  const recentActivity = useMemo(() => {
    ...
    if (latestCase) {
      ...
      items.push({
        ...
        time: "Recently",
        icon: Scan,
        href: `/records?focusScan=${latestScan.id}`,
        color: "bg-icon-primary-subtle text-icon-primary",
      });
    }
          ...
          {stats.map((stat) => {
            ...
            return (
              <motion.div key={stat.id} variants={itemVariants}>
                ...
                >
                  <Card className="h-full rounded-2xl border border-border transition-all duration-200 group-hover:-translate-y-1 group-hover:shadow-lg group-hover:border-primary/40 active:scale-[0.98]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {quickActions.map((action, i) => {
              ...
              return (
                ...
                >
                  <Link to={action.path}>
                    <Card className="h-full rounded-2xl border border-border transition-all duration-200 hover:shadow-lg hover:border-primary/30 hover:-translate-y-0.5 cursor-pointer">
