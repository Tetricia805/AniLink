    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-6 md:py-8 max-w-5xl">
        ...
        {orders.length === 0 ? (
          ...
          >
            {orders.map((order) => (
              <motion.div key={order.id} variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0 } }}>
              <Card key={order.id} className="border border-border transition-all duration-200 hover:shadow-lg hover:border-primary/30 active:scale-[0.99]">
