...
import { RecordsScanPage } from '@/pages/RecordsScanPage'
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute allowedRoles={['OWNER']} />}>
        <Route element={<AppShell />}>
          ...
          <Route path="/scan/start" element={<QuickScanPage />} />
          <Route path="/scan/symptoms" element={<SymptomCheckerPage />} />
          <Route path="/records" element={<RecordsPage />} />
          <Route path="/records/scan" element={<RecordsScanPage />} />
